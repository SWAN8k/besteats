...
import { AiFillTag, AiFillTags, AiOutlineClose, AiOutlineMenu, AiOutlineSearch } from 'react-icons/ai'
...
function Navbar() {
  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      {/* cart */}
      <button href='/ShoppingCart' className='bg-black text-white hidden md:flex items-center py-2 rounded-full'>
      ...
      {/* overlay */}
      {nav
        ? <div onClick={handleNav} className="bg-black/80 fixed w-full h-screen z-10 top-0 left-0"></div>
        : ''
      }
      ...
      <div onClick={handleNav}
        ...
        <nav className=''>
          <ul className='flex flex-col p-4 text-gray-800'>
            ...
            <li className='text-xl py-4 flex cursor-pointer'><AiFillTags size={25} className='mr-4' /> Promotions</li>
